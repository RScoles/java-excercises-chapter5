...
public class Student {
    ...
    public static void main(String[] args) {
        Student myself = new Student("Ryan", 1, 30, 4.0);
        Student twin = new Student("Rya", 2, 20, 2.0);
    ...
    public int getNumberOfCredit() {return this.numberOfCredits;}
